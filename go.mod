module github.com/bootc-dev/bink

go 1.25.8

require (
	github.com/containers/podman/v6 v6.0.0-20260420221920-98ca040cd7a4
...
require (
	...
	github.com/containers/buildah v1.42.1-0.20260417103105-4e43fa8d9e07 // indirect
	...
	go.podman.io/image/v5 v5.39.3-0.20260416202057-7d53666cdee9 // indirect
	go.podman.io/storage v1.62.1-0.20260416202057-7d53666cdee9 // indirect
